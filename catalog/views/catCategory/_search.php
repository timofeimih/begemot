...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'picSettings'); ?>
		<?php echo $form->textArea($model,'picSettings',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tName',array('size'=>60,'maxlength'=>70)); ?>
	</div>
