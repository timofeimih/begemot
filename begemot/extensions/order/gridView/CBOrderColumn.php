...
class CBOrderColumn extends CButtonColumn
{
    ...
    public $upButtonUrl = 'Yii::app()->controller->createUrl("orderUp",array("id"=>$data->primaryKey))';
    ...
    public $downButtonUrl = 'Yii::app()->controller->createUrl("orderDown",array("id"=>$data->primaryKey))';
