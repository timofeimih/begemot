...
class PostsTagsController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('PostsTags');
	...
	{
		$model=PostsTags::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='posts-tags-form')
		{
